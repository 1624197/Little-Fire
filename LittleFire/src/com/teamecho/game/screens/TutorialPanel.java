...
public class TutorialPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public TutorialPanel(Game theGame) {
        game = theGame;
    ...
    private void initPanel() {
        ...
        try {
            backgroundImage = ImageIO.read(getClass().getResource("/Images/Screens/TutorialScreen.png"));
        } catch (Exception ex) {
            System.err.println("Error Loading Tutorial Screen Image");
        }
        ...
        MainMenuButton.setX(70);
        MainMenuButton.setY(500);
    }
