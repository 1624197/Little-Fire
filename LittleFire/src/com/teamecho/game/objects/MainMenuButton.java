...
public class MainMenuButton {
    ...
    public void initButton() {
        try {
            sprite = ImageIO.read(getClass().getResource("/Images/Objects/ButtonsOff/MenuOff.png"));
        } catch (Exception ex) {
            System.err.println("Error loading menu button");
        }
    ...
    public void setImage(int Select) {
        switch (Select) {
            ...
            System.err.println("Error loading menuoff button image");
        }
                break;
            case 2:
                try {
            sprite = ImageIO.read(getClass().getResource("/Images/Objects/ButtonsOn/MenuOn.png"));
        } catch (Exception ex) {
            System.err.println("Error loading menuon button image");
        }
                break;
            default:
        }
