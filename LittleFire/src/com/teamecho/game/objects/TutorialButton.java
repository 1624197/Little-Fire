...
public class TutorialButton {
    ...
    public void initButton() {
        try {
            sprite = ImageIO.read(getClass().getResource("/Images/Objects/ButtonsOff/TutorialOff.png"));
        } catch (Exception ex) {
            System.err.println("Error loading Tutorial Button button");
        }
    ...
    public void setImage(int Select) {
        switch (Select) {
            ...
            case 2:
                try {
            sprite = ImageIO.read(getClass().getResource("/Images/Objects/ButtonsOn/TutorialOn.png"));
        } catch (Exception ex) {
            System.err.println("Error loading start button image");
        }
                break;
