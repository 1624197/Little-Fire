...
public class CreditsPanel extends JPanel implements MouseListener, MouseMotionListener {
    ...
    public CreditsPanel(Game theGame) {
        game = theGame;
    ...
    private void initPanel() {
        ...
        try {
            backgroundImage = ImageIO.read(getClass().getResource("/Images/Screens/CreditsScreen.png"));
        } catch (Exception ex) {
            System.err.println("Error Loading credits Screen Image");
        }
        ...
        MainMenuButton.setX(50);
        MainMenuButton.setY(100);
    }
